  ...
  return (
    <>
      <Container>
        ...
        <h2>Визитки</h2>
        <p>
          Визитка – это небольшая карточка, обычно размером с визитную карточку,
          которая содержит информацию о человеке или организации. Она является
          одним из наиболее популярных и эффективных инструментов маркетинга и
          коммуникации. Визитки играют важную роль в бизнес-среде, так как они
          предоставляют возможность представить себя или свою компанию в краткой
          и лаконичной форме. Они содержат основную информацию, такую как имя,
          должность, контактные данные и логотип компании. Визитка может также
          включать информацию о продуктах или услугах, предлагаемых
          организацией. Преимущества использования визиток очевидны. Во-первых,
          они являются незаменимым инструментом для обмена контактами и
          установления деловых связей. Когда вы встречаетесь с потенциальными
          клиентами, партнерами или коллегами, вы можете легко передать им свою
          визитку, чтобы они имели ваши контактные данные под рукой. Визитки
          также помогают создать профессиональный и надежный образ вашей
          компании. Хорошо оформленная и качественная визитка говорит о
          серьезности вашего бизнеса и профессионализме. Она может стать первым
          визуальным впечатлением о вас или вашей компании, поэтому важно
          уделить внимание ее дизайну и содержанию.
        </p>
      </Container>
    </>
  );
