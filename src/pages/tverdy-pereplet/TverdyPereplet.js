...
<div className="wrapper">
    <div className="col-6">
        <img src="/file/tverdy-pereplet/diplom.jpg" alt="полиграфия"></img>
        </div>
    <div className="col-6">
        ...
        <div className="mid">
            ...
            <div className="mid-23">
                ...
                <select name="lam" className="search-form__field" id="cars" value={side} onChange={event => setSide(event.target.value)}>
                    <option value="one" >от 20 до 100 стр.</option>
                    <option value="two" >от 100 до 150 стр.</option>
                    <option value="tre" >от 150 до 200 стр.</option>
                    <option value="tre" >от 200 до 300 стр.</option>
                    <option value="tre" >от 300 до 350 стр.</option>
                </select>
            </div>
        </div>
